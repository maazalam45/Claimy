...
type Props = NativeStackScreenProps<ClaimStackParamList, 'ClaimQRCode'>;
...
export function ClaimQRCodeScreen({ navigation, route }: Props) {
  const { statusTitle } = route.params;
  ...
  return (
    <Screen padded={false} backgroundColor={colors.black}>
      <View style={styles.root}>
        ...
        <Text style={styles.claim}>{statusTitle} claim</Text>
...
const styles = StyleSheet.create({
  ...
  centerDot: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(178,109,255,0.4)',
  },
  required: {

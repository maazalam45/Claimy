...
type Props = NativeStackScreenProps<ProfileSetupStackParamList, 'ProfileSetupNull'>;

export function ProfileSetupNullScreen({ navigation }: Props) {
  const reset = useProfileSetupStore(state => state.reset);

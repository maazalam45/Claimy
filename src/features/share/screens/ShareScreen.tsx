    ...
    <Screen padded={false} backgroundColor={colors.black}>
      <View style={[styles.root, styles.rootTheme]}>
        ...
        <View style={styles.header}>
          ...
          <Pressable onPress={() => navigation.navigate('Share1')} style={styles.postBtn}>
        ...
        <GlassCard style={[styles.card, styles.cardTheme]}>
          <View style={styles.badges}>
            <View style={styles.badge}><Text style={styles.badgeText}>IT'S OFFICIAL</Text></View>
            <Text style={styles.brandMini}>CLAIMY</Text>
          </View>
          ...
          <Text style={styles.desc}>Have successfully claimed each other on Claimy</Text>
          <View style={styles.statusBar}>
            <View>
              <Text style={styles.statusLabel}>STATUS</Text>
              <Text style={styles.statusValue}>Talking Stage</Text>
            </View>
            <View style={styles.statusOrb}><Text style={styles.statusOrbText}>◌</Text></View>
          </View>
          <View style={styles.footRow}>
            <Text style={styles.footText}>AUTHENTICATED</Text>
            <Text style={styles.qr}>▦</Text>
          </View>
          <View style={styles.footRow}>
            <Text style={styles.footText}>CLAIMY CERTIFIED</Text>
            <Text style={styles.qr}>▦</Text>
          </View>
        </GlassCard>
...
const styles = StyleSheet.create({
  ...
  rootTheme: { backgroundColor: '#1A1333' },
  topGlow: { ...StyleSheet.absoluteFillObject, top: -80, height: 460, backgroundColor: 'rgba(120,78,255,0.22)' },
  topGlowTheme: { backgroundColor: 'rgba(120,78,255,0.22)' },
  ...
  card: { marginTop: 26, padding: spacing.lg, borderRadius: 28 },
  cardTheme: { backgroundColor: '#5A43A6', borderColor: 'rgba(255,255,255,0.16)' },
  ...
  name: { marginTop: spacing.md, textAlign: 'center', color: colors.white, fontSize: 38 / 2, fontWeight: '900' },
  ...
  statusValue: { color: colors.white, marginTop: 2, fontSize: 31 / 2, fontWeight: '700' },
  statusOrb: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(130,94,255,0.25)', borderWidth: 1, borderColor: 'rgba(130,94,255,0.45)', alignItems: 'center', justifyContent: 'center' },
  statusOrbText: { color: '#B88DFF', fontSize: 16, fontWeight: '800' },
